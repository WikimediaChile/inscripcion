...
$fat->route('POST /@permalink/add', '\route\event->addTalk');
...
$fat->route('GET /coordination/add', '\route\coordination->event_add');
$fat->route('POST /coordination/create', '\route\coordination->event_update');
